...
contextBridge.exposeInMainWorld('electronAPI', {
  ...
  postComments: (prUrl: string, comments: unknown[], reviewType: string, reviewBody?: string) =>
    ipcRenderer.invoke('github:postComments', prUrl, comments, reviewType, reviewBody),
